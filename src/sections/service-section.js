...
import ServiceThumb from 'assets/thumbnail.png';
...
const data = {
  subTitle: 'About us',
  title: 'Connecting your brand to the digital world',
  features: [
    {
      id: 1,
      imgSrc: Smart,
      ...
      text:
        'We shoot, produce and create quality content for your brand. From copywriting to producing a complete video is now at your fingertips.',
    },
    {
      id: 2,
      imgSrc: Secure,
      ...
      text:
        'We help to promote your brand to connect with potential audience. From managing to marketing your content is just one click away.',
    },
  ],
};
